...
export function UploadGuide({ onBack, onFinish, onOpenInstagram }: {
  onBack: () => void;
  onFinish: () => void;
  ...
  return <main className="brand-page upload-guide-page">
    ...
    <section className="guide-screen">
      ...
      <a className="primary-button" href={INSTAGRAM_EXPORT_URL} target="_blank" rel="noreferrer" onClick={onOpenInstagram}>
